...
<html>
<head>
  <title>Kwitansi Karangampel</title>
  <meta charset="utf-8">
  ...
  <tr>
    <td align="left" valign="top"><table width="750" border="0" cellspacing="0" cellpadding="4">
      ...
      <tr>
        ...
        <td colspan="3">: Sisa Tagihan Rp. <strong><?php echo $sisa; ?></strong>,- 
        <?php
         if ($data==0)
		 {
			 echo "<B>LUNAS</B>";
      ...
      <tr>
        <td height="30" align="center" bgcolor="#00CC00"># Rp.<strong><?php echo number_format($data['nominal'],0); ?></strong>,- #</td>
        <td colspan="3">&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
