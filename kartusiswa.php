...
$query = mysql_query("SELECT * FROM tbl_siswa WHERE no_induk='$no_induk'");
...
<div class='card'>
  ...
  <article>
    <img alt='My Pic' id='thumb' src='gambar/logo.gif'>
    <h2>Get House Karangampel</h2>
    <div class='area'>
      <h3 style="font-style: italic;">Jalan Raya Barat No 19 Karangampel</h3>
      <ul>
        <li>
          No Induk
          <span>: <?php echo $data['no_induk'];?></span>
        </li>
        <li>
          Nama&nbsp;&nbsp;&nbsp;&nbsp;
